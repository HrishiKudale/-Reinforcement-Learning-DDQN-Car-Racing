...
GOAL_REWARD = 1  # Renamed GOALREWARD to GOAL_REWARD
LIFE_REWARD = 0
PENALTY = -1
...
class Car:
    def __init__(self, x, y):
        ...
        self.original_image = pygame.image.load("E:/DDQN-Car-Racing-main/DDQN-Car-Racing-main/car.png").convert()
...
class RacingEnv:
    ...
    def __init__(self):
        ...
        self.back_image = pygame.image.load("E:/DDQN-Car-Racing-main/DDQN-Car-Racing-main/track.png").convert()
        ...
        for goal in self.goals:
            ...
            if goal.isactive:
                if self.car.score(goal):
                    goal.isactive = False
                    self.goals[index-2].isactive = True
                    reward += GOAL_REWARD
